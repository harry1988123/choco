...
ALTER TABLE "users" ALTER COLUMN "role" SET DATA TYPE varchar(12);--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pincode_idx" ON "warehouses" USING btree ("pincode");--> statement-breakpoint
